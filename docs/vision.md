...
Nothing on the machine shows those three together. `htop` shows a `node` process and no idea whose it is or what it is spending. The harnesses each show their own session and nothing about the others. When an agent dies and leaves its MCP servers behind, nobody notices until the machine swaps. That failure is not hypothetical: Codex has a series of bug reports where completed subagents kept whole stdio MCP process trees alive ([#12491](https://github.com/openai/codex/issues/12491), [#17574](https://github.com/openai/codex/issues/17574), [#25015](https://github.com/openai/codex/issues/25015), [#16256](https://github.com/openai/codex/issues/16256)), three of them still open, and [#19753](https://github.com/openai/codex/pull/19753) fixing one path only, back in April 2026. Every harness that spawns helper processes has the same shape of bug waiting.
